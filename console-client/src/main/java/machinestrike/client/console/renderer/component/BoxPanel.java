...
public class BoxPanel extends Panel {
    ...
    public record Outline(char horizontal, char vertical, char corner, int width, int height) {
    }
    ...
    public void renderPanel(Graphics g) {
        ...
        g.fillRect(topRect.intersection(section), outline.horizontal);
        g.fillRect(bottomRect.intersection(section), outline.horizontal);
        g.fillRect(leftRect.intersection(section), outline.vertical);
        g.fillRect(rightRect.intersection(section), outline.vertical);
        ...
        g.fillRect(topLeftCorner.intersection(section), outline.corner);
        g.fillRect(topRightCorner.intersection(section), outline.corner);
        g.fillRect(bottomLeftCorner.intersection(section), outline.corner);
        g.fillRect(bottomRightCorner.intersection(section), outline.corner);
    }
